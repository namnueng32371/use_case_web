...
เปิด PowerShell ธรรมดา (ไม่ต้อง admin) ไปที่โฟลเดอร์โปรเจกต์แล้วรัน [schema.sql](schema.sql) เพื่อสร้าง database และตาราง (เริ่มต้นว่างเปล่า พร้อมกรอกข้อมูลจริง):
...
เปิดเบราว์เซอร์ไปที่ `http://localhost:8765` — ควรเห็นหน้าแอป พร้อมรายการ use case ว่างเปล่า (หรือมีข้อมูลถ้า import backup ไว้ในขั้นที่ 5) เพิ่มรายการแรกผ่านปุ่ม "+ เพิ่ม use case ใหม่" ได้เลย
